...
public class BasicSender implements RabbitService {
    ...
    public String send(){
        String msg = msg();
        amqpTemplate.convertAndSend(RabbitService.BASIC_QUEUE, msg);
        log.info(msg);
        return msg;
    }
    ...
    public String msg() {
        ...
        return String.format(RabbitService.MSG, RabbitService.BASIC, andIncrement, RabbitService.BASIC_EXCHANGE, RabbitService.BASIC_QUEUE);
    }
}