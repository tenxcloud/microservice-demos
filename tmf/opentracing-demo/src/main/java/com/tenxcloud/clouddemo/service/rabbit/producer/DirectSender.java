...
public class DirectSender implements RabbitService {
    ...
    public String send(){
         ...
         * 第三个参数即消息。
         */
        amqpTemplate.convertAndSend(RabbitService.DIRECT_EXCHANGE, RabbitService.DIRECT_QUEUE, msg);
        log.info(msg);
        return msg;
    }
    ...
    public String msg() {
        ...
        return String.format(RabbitService.MSG, RabbitService.DIRECT, andIncrement, RabbitService.DIRECT, RabbitService.DIRECT_QUEUE);
    }
}
